...
Gitignored copies of vendor PDFs and text extracted for agents. The
catalog is [datasheets.md](../datasheets.md). Nothing in `pdf/` or
`md/` is committed. SHA-256 of those files is committed next to the
catalog ([datasheets.sha256](../datasheets.sha256),
