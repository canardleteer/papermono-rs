...
supports analog-to-digital conversions, battery status reads and
state-of-charge calculation (`battery_percent`), status LED control over
`LED_EN_PP`, and software power-down through an explicit method.
