...
pub use m5pm1::{
    adc_mv, battery_percent, pwm0_bytes, pwm_freq_bytes, BATTERY_EMPTY_MV, BATTERY_FULL_MV, CHG_EN,
    DEVICE_ID, FRONTLIGHT_DUTY, FRONTLIGHT_PWM_HZ, GPIO3_FUNC_MASK, GPIO3_FUNC_PWM, GPIO_DRV,
    GPIO_FUNC0, GPIO_IN, GPIO_MODE, GPIO_PULL_UP, GPIO_PUPD0, GPIO_WAKE_CFG, GPIO_WAKE_EN,
    HOLD_CFG, HOLD_LDO, HOLD_VIN, IRQ_MASK1, IRQ_STATUS1, IRQ_STATUS2, IRQ_STATUS3, LED_EN,
    PWM0_DUTY_MAX, PWM0_EN, PWM0_HC, PWM0_L, PWM_FREQ_L, PWR_CFG, PWR_SRC, PWR_SRC_BAT,
    PWR_SRC_VIN, PWR_SRC_VINOUT, SYS_CMD, SYS_CMD_KEY, SYS_CMD_SHUTDOWN, VBAT_L, VIN_L,
    VIN_PRESENT_MV, WAKE_SRC, WAKE_SRC_EXT,
};
